...
func main() {
	sqlConnection, err := sql.Open("sqlite", "tracker.db") // настройте подключение к БД
	...
	store := NewParcelStore(sqlConnection) // создайте объект ParcelStore функцией NewParcelStore
